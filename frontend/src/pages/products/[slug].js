import { useGlobalContext } from "@/Components/context-api/AppContext";
import { Cart } from "@/Components/icons/svg";
    ...
    return (
        <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                ...
                <button
                    className="
						focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-900
						text-base
						flex
                        space-x-1
                        font-bold
